            ...
            <div className="">
                <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="descriacao">1 - Demora pela entrega
                            2 - Demora pela atualização do cadastro de reserva.
                            3 - Ocupação do local
                        </div>

                        <div className="img"><img src="imgEstudo1/personaAna.png" alt="Personagem Ana" /></div>
                        <div className="font-semibold">Personagem: Ana</div>
                        <div className="descriacao">Ana é médica, que precisa de lugares com atendimentos rápidos, porque não
                            tem tempo de fazer as refeições;
                        </div>

                        <div className="img"><img src="imgEstudo1/actionAna.png" alt="Ação da Ana" /></div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="img"><img src="imgEstudo1/lo-fiRestaurante.png" alt="Wireframes digital" /></div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="img"><img src="imgEstudo1/mockupsBefAndAft.png" alt="Mockups" /></div>
                        ...
                        <div className="img"><img src="imgEstudo1/mockupsBefAndAft2.png" alt="Mockups" /></div>
                        <div className="font-semibold">Mockups:</div>
                        <div className="descriacao">
